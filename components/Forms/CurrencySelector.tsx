 ...
 *
 * @component
 * @param {CurrencySelectorProps} props - The component props.
 * @returns {JSX.Element} The CurrencySelector component.
 */
export default function CurrencySelector({ name, currencies, control }: CurrencySelectorProps): JSX.Element {
