...
const LoadingButton = ({ isLoading, onClick, children, openError, active = true }) => {
  let buttonStyles = "w-full h-10 flex space-x-2 justify-between items-center px-4 py-3 border border-transparent w-full md:w-auto text-sm font-medium rounded shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 ";
