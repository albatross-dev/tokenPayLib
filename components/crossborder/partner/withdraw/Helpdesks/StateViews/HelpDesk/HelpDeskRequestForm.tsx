...
export default function HelpDeskRequestForm({
  textareaContent,
  error,
  setTextareaContent,
  handleStartTransaction,
}: HelpDeskRequestFormProps) {
  const { t: tCrossborder } = useTranslation("crossborder");

  return (
    <div className="flex flex-col gap-4">
      <div className="text-2xl font-bold">
        {tCrossborder("withdraw.helpdeskRequest.transactionDetails")}
      </div>
      <div>
      ...
      <textarea
        ...
        placeholder={tCrossborder(
          "withdraw.helpdeskRequest.placeholderDetails"
        )}
      ></textarea>
