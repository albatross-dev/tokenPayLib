...
export default function KotaniPayHelpDeskKYCFormConsumer({ setValue, methods }) {
  ...
  const ovexB2BKYCInfo = [
    ...
    {
      type: "ui",
      content: <div className="font-bold text-xl">{tCrossborder("withdraw.helpDeskKYC.consumer.kotani.kotaniInfo")}</div>,
    },
    {
      name: "kotaniVolume",
