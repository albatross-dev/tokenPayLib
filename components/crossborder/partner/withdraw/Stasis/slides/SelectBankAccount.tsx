...
export default function SelectBankAccount({ bankAccounts, setView, setSelectedBankAccount }: SlideProps) {
  ...
  return (
    <div className="max-w-96 w-full mb-16 mt-4">
      <h2 className="text-xl font-semibold mb-4">{tCrossborder("withdraw.stasis.chooseBankaccount")}</h2>
      {bankAccounts.length > 0 ? (
        ...
        <p className="text-gray-600">{tCrossborder("withdraw.stasis.noAccountAvailable")}</p>
      )}
      <button
