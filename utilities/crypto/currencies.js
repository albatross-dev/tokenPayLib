...
// polygon
const currencies = polygonCurrencies;

export const currenciesBase = baseCurrencies;

export const currenciesArbitrum = arbitrumCurrencies

export const currenciesEthereum = ethereumCurrencies;

export const currenciesOP = optimismCurrencies;
